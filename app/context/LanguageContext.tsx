...
const translations = {
  en: {
    ...
    "work.project6Description":
      "A movie discovery application featuring a browseable catalog of films, detailed movie information, ratings, and search functionality powered by an external API.",
    ...
    "contact.email": "Email",
    "contact.emailMessage": "Direct messaging",
    "contact.emailSendMessage": "Message",
    "contact.linkedIn": "LinkedIn",
    "contact.linkedInMessage": "Direct messaging",
    "contact.linkedInSendMessage": "Message",
    "contact.phone": "Phone",
    "contact.otherWays": "Other Ways to Connect",
    "contact.otherWaysDescription":
  ...
  ar: {
    ...
    "hero.cv": "قم بتنزيل السيرة الذاتية",
    "about.intro": "مقدمة",
    ...
    "contact.otherWays": "طرق اخرى للتواصل",
    "contact.otherWaysDescription": "اختر طريقتك المفضلة",
    "contact.emailMessage": "مراسلة مباشرة",
    "contact.emailSendMessage": "رسالة",
    "contact.linkedIn": "لينكد إن",
    "contact.linkedInMessage": "مراسلة مباشرة",
    "contact.linkedInSendMessage": "رسالة",
  },
} as const;
